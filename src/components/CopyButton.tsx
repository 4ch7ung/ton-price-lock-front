...
export function CopyButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <div style={{ width: 16, height: 16 }} onClick={handleClick}>
      {isCopied ? (
        <svg width="14" height="12" viewBox="0 0 14 12" fill="none" style={{ fill: "#62D488" }} xmlns="http://www.w3.org/2000/svg">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="copy-button-icon" viewBox="0 0 16 16">
